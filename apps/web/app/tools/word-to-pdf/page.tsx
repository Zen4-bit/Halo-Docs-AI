...
import { 
  ...
  X, FileType2, Settings2, Type, Layout
} from 'lucide-react';
      ...
      <div className="relative overflow-hidden border-b border-zinc-800">
        ...
        <div className="relative max-w-5xl mx-auto px-6 py-16">
          <div className="flex items-center gap-4 mb-4">
            <div className="p-4 rounded-2xl bg-gradient-to-br from-blue-600 to-blue-400 shadow-lg shadow-blue-500/25">
          ...
          <h1 className="text-4xl font-bold text-white mb-3">Word to PDF</h1>
          <p className="text-lg text-zinc-400 max-w-2xl">
            Convert Microsoft Word documents to PDF format with preserved formatting and fonts.
          </p>
        </div>
      </div>
          ...
          <div className="space-y-8">
            ...
            {!file ? (
              <div
                ...
                className="relative border-2 border-dashed border-zinc-700 hover:border-blue-500/50 rounded-2xl p-12 transition-all duration-300 bg-zinc-900/30 hover:bg-blue-500/5 group"
              >
                <input
                  type="file"
                  accept=".doc,.docx"
                ...
                <div className="text-center">
                  <div className="inline-flex p-4 rounded-2xl bg-zinc-800/50 group-hover:bg-blue-500/20 transition-colors mb-4">
                    <Upload className="w-10 h-10 text-zinc-400 group-hover:text-blue-400 transition-colors" />
                  </div>
                  <h3 className="text-xl font-semibold text-white mb-2">Drop your Word document here</h3>
                  <p className="text-zinc-500">or click to browse</p>
                  <div className="mt-4 flex items-center justify-center gap-3">
                    <span className="px-3 py-1 rounded-full text-xs bg-blue-500/20 text-blue-400">.DOC</span>
                    <span className="px-3 py-1 rounded-full text-xs bg-blue-500/20 text-blue-400">.DOCX</span>
                  </div>
                </div>
              </div>
            ) : (
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <label className="flex items-center gap-3 p-4 rounded-xl bg-zinc-800/50 border border-zinc-700/50 cursor-pointer hover:border-zinc-600 transition-colors">
                    <input
                      ...
                      className="w-5 h-5 rounded border-zinc-600 text-blue-500 focus:ring-blue-500/20"
                    />
                    <div>
                      ...
                      <p className="text-sm text-zinc-500">Maintain original formatting</p>
                    </div>
                  </label>
                  <label className="flex items-center gap-3 p-4 rounded-xl bg-zinc-800/50 border border-zinc-700/50 cursor-pointer hover:border-zinc-600 transition-colors">
                    <input
                    ...
                    <div>
                      ...
                      <p className="text-sm text-zinc-500">Include fonts in PDF</p>
                    </div>
                  </label>
                </div>

                <div>
                  <label className="block text-sm font-medium text-zinc-300 mb-3">Compression Level</label>
              ...
              <button
                ...
                className={`w-full py-4 px-6 rounded-xl font-semibold text-lg transition-all flex items-center justify-center gap-3 ${
                  processing
                    ...
                    : 'bg-gradient-to-r from-blue-600 to-blue-400 text-white hover:shadow-lg hover:shadow-blue-500/25 hover:scale-[1.02] active:scale-[0.98]'
                }`}
              >
                {processing ? (
                  <>
