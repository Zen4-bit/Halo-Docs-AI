...
export default function PDFToWordPage() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      setResult({ url, name: file.name.replace('.pdf', '.docx'), size: blob.size });
    } catch (err: any) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-950">
      ...
      <div className="relative overflow-hidden border-b border-zinc-800">
        ...
        <div className="relative max-w-5xl mx-auto px-6 py-16">
          ...
          <h1 className="text-4xl font-bold text-white mb-3">PDF to Word</h1>
          <p className="text-lg text-zinc-400 max-w-2xl">
            Convert PDF documents to editable Word files (.docx) while preserving formatting.
          </p>
        </div>
      </div>
            ...
            {file && (
              <div className="p-6 rounded-2xl bg-zinc-900/50 border border-zinc-800 space-y-6">
                ...
                <label className="flex items-center gap-3 p-4 rounded-xl bg-zinc-800/50 border border-zinc-700/50 cursor-pointer hover:border-zinc-600 transition-colors">
                  ...
                  />
                  <div>
                    <p className="text-white font-medium">Preserve Layout</p>
                    <p className="text-sm text-zinc-500">Maintain original document formatting</p>
                  </div>
                </label>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-zinc-800 border border-zinc-700 text-white placeholder-zinc-500 focus:border-blue-500 focus:outline-none"
                  />
                </div>
              </div>
            )}
              ...
              <button
                ...
                className={`w-full py-4 px-6 rounded-xl font-semibold text-lg transition-all flex items-center justify-center gap-3 ${
                  processing
                    ...
                    : 'bg-gradient-to-r from-blue-500 to-indigo-500 text-white hover:shadow-lg hover:shadow-blue-500/25 hover:scale-[1.02] active:scale-[0.98]'
                }`}
              >
                {processing ? (
                  <>
