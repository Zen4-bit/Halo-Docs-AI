                        ...
                        {steps.map((step, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <Card
                                        variant="glass"
                                        className="relative h-full p-10 rounded-[2.5rem] hover:bg-surface transition-all duration-300 group z-10"
                                        hoverEffect={false}
                                    >
                                        {/* Step Number */}
                                        <div className="absolute -top-8 left-10">
                                            <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${step.color} flex items-center justify-center shadow-2xl shadow-primary/20 group-hover:scale-110 transition-transform duration-300`}>
                                        ...
                                        <div className="mb-8 mt-8">
                                            <div className="w-20 h-20 bg-surface-highlight rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 border border-border">
