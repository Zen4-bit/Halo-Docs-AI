...
npm install pdf-lib@^1.17.1 pdfjs-dist@^3.11.174

echo ""
echo "[2/3] Installing Office Document Libraries..."
npm install mammoth@^1.6.0 xlsx@^0.18.5 jspdf@^2.5.1 jspdf-autotable@^3.7.1 html2canvas@^1.4.1

echo ""
echo "[3/3] Installing Media Processing Libraries..."
npm install @ffmpeg/ffmpeg@^0.12.7 @ffmpeg/util@^0.12.1 browser-image-compression@^2.0.2

echo ""
echo "================================================"
echo "Installing Type Definitions (optional)..."
echo "================================================"
npm install --save-dev @types/pdfjs-dist @types/node
